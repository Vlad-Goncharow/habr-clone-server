...
router.get('/user/comments/:id/:page', CommentsController.getUserComments)
router.get('/user/favorites/:id/:page', UserController.getUserFavorites)
router.get('/user/profile/:id', UserController.getUserProfile)
router.get('/user/posts/:id/:page', UserController.getUserPosts)
router.get('/user/subs/:id/:type/:page', UserController.getUserSubs)
